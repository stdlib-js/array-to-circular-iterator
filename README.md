...
```javascript
circarray2iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-to-circular-iterator@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-to-circular-iterator@umd/bundle.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/array-to-circular-iterator/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/array-to-circular-iterator/actions/workflows/test.yml?query=branch:main
