...
```javascript
import circarray2iterator from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-to-circular-iterator@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-to-circular-iterator/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/array-to-circular-iterator/actions/workflows/test.yml?query=branch:v0.2.2
