...
var circarray2iterator = require( './../../dist' );
...
tape( 'the function throws an error if provided a first argument which is not an array-like object', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			circarray2iterator( value );
		};
	}
});

tape( 'the function throws an error if provided a first argument which is not an array-like object (options)', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided a callback argument which is not a function (no options)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			circarray2iterator( [ 1, 2, 3, 4 ], value );
		};
	}
});
...
tape( 'the function throws an error if provided an `iter` option which is not a nonnegative integer (no callback)', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided an `iter` option which is not a nonnegative integer (callback)', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns an iterator protocol-compliant object which repeatedly iterates over elements of an array-like object (array; options)', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
...
tape( 'the function returns an iterator protocol-compliant object which repeatedly iterates over the elements of an array-like object (array-like object)', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
...
tape( 'the function returns an iterator protocol-compliant object which repeatedly iterates over elements of an array-like object (empty)', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
...
tape( 'the function returns an iterator protocol-compliant object which supports invoking a provided function for each iterated value', function test( t ) {
	...
	it = circarray2iterator( values, scale );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object which supports invoking a provided function for each iterated value (empty)', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
...
tape( 'the function supports limiting the number of iterations (callback)', function test( t ) {
	var expected;
	var actual;
	var values;
	var opts;
...
tape( 'the returned iterator has a `return` method for closing an iterator (no argument; callback)', function test( t ) {
	...
	it = circarray2iterator( [ 1, 2, 3, 4 ], scale );
...
tape( 'if an environment supports `Symbol.iterator`, the returned iterator is iterable', function test( t ) {
	var circarray2iterator;
	var values;
	var it1;
	var it2;
	var i;

	circarray2iterator = proxyquire( './../dist/main.js', {
		'@stdlib/symbol-iterator': '__ITERATOR_SYMBOL__'
	});

	values = [ 1, 2, 3, 4 ];

	it1 = circarray2iterator( values );
...
tape( 'if an environment supports `Symbol.iterator`, the returned iterator is iterable (callback)', function test( t ) {
	...
	it1 = circarray2iterator( values, scale );
	t.equal( typeof it1[ '__ITERATOR_SYMBOL__' ], 'function', 'has method' );
	t.equal( it1[ '__ITERATOR_SYMBOL__' ].length, 0, 'has zero arity' );
